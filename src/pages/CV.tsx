...
import {awards, education, overview, personalInfo, skills, workExperience,} from "../data/portfolio-data";
                    ...
                    <div className={styles.headerLeft}>
                        <div className={styles.contactInfo}>
                            ...
                            <p><strong>GitHub:</strong> <a
                                href={personalInfo.github}>{personalInfo.github.split('/').pop()}</a></p>
                        </div>
                    </div>
                            ...
                            {projects.slice(0, 4).map((project, index) => (
                                <div key={index} className={styles.projectItem}>
                                    <div className={styles.projectHeader}>
                                        ...
                                        <span
                                            className={styles.projectTech}>{project.technologies.slice(0, 4).join(", ")}</span>
                                    </div>
                                </div>
                            ))}
                        </section>
