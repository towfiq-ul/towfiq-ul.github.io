...
export function WhatsAppChat({isChatOpen = false}: WhatsAppChatProps) {
    const [isOpen, setIsOpen] = useState(isChatOpen);
    const [isVisible, setIsVisible] = useState(false);
    const phoneNumber = personalInfo.whatsapp
    const message = "Hello Towfiqul! I visited your portfolio and would like to connect with you."
                ...
                <div className={styles.chatPopup}>
                    <div className={styles.chatHeader}>
                        <div className={styles.chatHeaderContent}>
                            <div className={styles.avatar}>
                                <MessageCircle className={styles.avatarIcon}/>
                            </div>
                            <div className={styles.headerText}>
                                <h3 className={styles.headerTitle}>Start a Conversation</h3>
                                <p className={styles.headerSubtitle}>Usually replies within an hour</p>
                            </div>
                        </div>
                    ...
                    <div className={styles.chatBody}>
                        <div className={styles.messageBubble}>
                            <p className={styles.messageText}>Hi there! 👋</p>
