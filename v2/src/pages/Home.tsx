  ...
  return (
    <div className={styles.page}>
        ...
        <div className={styles.heroContent}>
          <div className={styles.heroGlass}>
            ...
            <p className={styles.heroDescription}>
              Building scalable enterprise solutions with {totalExp.years}+ years of expertise in Java, Spring Boot, Cloud Technologies, and Full-Stack Development
            </p>
          ...
          <div className={styles.overviewCard}>
            ...
            <ul className={styles.highlightsList}>
              {overview.highlights.map((highlight, index) => (
                <li key={index} className={styles.highlightItem} style={{ animationDelay: `${index * 0.1}s` }}>
                  {highlight}
                </li>
              ))}
            </ul>
          ...
          <div className={styles.overviewCard}>
            ...
            <div className={styles.expertiseGrid}>
              {overview.expertise.map((item, index) => (
                <div key={index} className={styles.expertiseItem} style={{ animationDelay: `${index * 0.1}s` }}>
      ...
      <section id="experience" className={`${styles.section} ${styles.sectionAlt}`}>
        <SectionHeader title="Work Experience" subtitle={`${formatExperience(totalExp.years, totalExp.months)} of Professional Software Development`} />
      ...
      <section id="awards" className={styles.section}>
        <SectionHeader title="Awards & Achievements" subtitle="Recognition in competitive programming and coaching" />
        ...
        {openSource.length > 0 && (
          <>
            <SectionHeader title="Open Source Contributions" subtitle="Contributing to the developer community" />
            <div className={styles.awardsList}>
              {openSource.map((contribution, index) => (
                <div key={index} className={styles.awardItem} style={{ animationDelay: `${index * 0.1}s` }}>
                  ...
                  <div className={styles.awardContent}>
                    ...
                    <p className={styles.awardDescription} style={{ fontSize: '13px', opacity: 0.8, marginBottom: '8px' }}>
                      {contribution.contribution}
                    </p>
                    <a href={contribution.link} target="_blank" rel="noopener noreferrer" className={styles.awardLink}>
      ...
      <section id="contact" className={styles.contactSection}>
        <div className={styles.contactGlass}>
          ...
          <div className={styles.contactGrid}>
            ...
            <a href={personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className={styles.contactCard}>
              <Linkedin className={styles.contactCardIcon} />
              <span>LinkedIn</span>
            </a>
            <a href={personalInfo.github} target="_blank" rel="noopener noreferrer" className={styles.contactCard}>
